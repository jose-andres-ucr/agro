...
import { useFetchUserData } from "@/app/hooks/useFetchData";
          ...
          {userAuth && userData && (
            <>
              ...
              <View>
                ...
                {fileUris && (
                  <Text>Archivo seleccionado: {fileUris.join(", ")}</Text>
                )}
                {loading ? (
                ...
                {comment.Name && comment.DateTime && comment.Comment ? (
                  <View style={stylesLocal.commentBox} key={comment.id}>
                    <View style={stylesLocal.commentContainer} key={comment.id}>
                      ...
                      <Text style={stylesLocal.commentDateTime}>
                        {new Date(comment.DateTime.toDate()).toLocaleString()}
                      </Text>
                      <Text style={stylesLocal.commentText}>
                        {comment.Comment}
                      </Text>
                      {Array.isArray(comment.Attachment) &&
                              ...
                              attachment.startsWith("http") ? (
                                attachment.includes(".jpg") ? (
                                  ...
                                  <View style={{ maxWidth: "100%" }}>
                                    ...
                                    />
                                    <View
                                      style={stylesLocal.videoControls}
                                    ></View>
                                  </View>
                                ) : attachment.includes(".mp3") ||
                                  attachment.includes(".wav") ? (
                                  <View>
                                    {isPlaying ? (
                                      <TouchableOpacity
                                        onPress={stopAudio}
                                  ...
                                  >
                                    <View
                                      style={stylesLocal.horizontalLine}
                                    ></View>
                                    <Text
                                      style={
                                        stylesLocal.selectedPostDescription
                                      }
                                    >
                                      {" "}
                                      Adjuntos:
                                  ...
                                  <Text style={stylesLocal.postAttachment}>
                            ...
                            <Button
                              ...
                              onPress={handleSubmit((data) => {
                                if (data.Response) {
                                  ...
                                  console.error(
                                    "El valor de Response está indefinido."
                                  );
                                }
                              })}
                            >
